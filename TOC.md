...
* [6-3. gsd — Get Shit Done 프로젝트 관리](pages/06-3-gsd.md)
* [6-4. RTK — Rust Token Killer 토큰 최적화](pages/06-4-rtk.md)
* [6-5. MCP 연동 및 외부 도구 연결](pages/06-5-mcp.md)
...
## 8장. 고급 운용 기법
* [8-1. 실제 멀티에이전트 운영 사례](pages/08-1-real-world.md)
* [8-2. GitHub Actions 기반 자동화](pages/08-2-github-actions.md)
* [8-3. 컨텍스트 관리 기법](pages/08-3-context-management.md)
* [8-4. 멀티에이전트 충돌 방지](pages/08-4-conflict-prevention.md)

---

## 9장. 운영 및 문제 해결
* [9-1. Remote-Control 인증 오류 해결](pages/09-1-auth-troubleshooting.md)
* [9-2. TMUX 세션 복구 및 재연결](pages/09-2-tmux-recovery.md)
* [9-3. 토큰 최적화 심화](pages/09-3-token-optimization.md)
