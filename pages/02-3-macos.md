...
**개발 토대(Xcode 도구·Homebrew)를 깔고**(1~2단계), **Git과 기본 유틸리티를 설치**(3~4단계)한 뒤 **Docker Desktop을 설치**합니다(5단계). Claude Code·tmux는 02-4·02-5에서 컨테이너 내부에 설치합니다.
...
macOS 호스트 환경 기본 설정을 한 번에 처리합니다. Node.js·tmux·Claude Code는 02-4 컨테이너 단계에서 설치합니다.
