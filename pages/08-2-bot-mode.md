...
![일반 모드 단순 경로와 Bot Mode 다단계 경로를 위아래로 대비한 비교 다이어그램](../assets/08-2-bot-mode-normal-vs-bot.png)
...
![여러 팀원의 완료 보고를 팀장이 취합해 사용자에게 단일 보고로 전달하는 fan-in 다이어그램](../assets/08-2-bot-mode-fan-in.png)
