...
**제어 레이어** — 📱 모바일 앱 / 🌐 claude.ai/code → Remote-Control

**로컬 머신 (Ubuntu/WSL2) — TMUX 세션 (team)**

| Pane | 이름 | 역할 | 실행 |
|------|------|------|------|
| 0 | 쭌 | 팀장 | Claude Code |
| 1 | 민준 | PM | Claude Code |
| 2 | 지훈 | 리서쳐 | Claude Code |
| 3 | 수아 | 디자이너 | Claude Code |
| 4 | 서연 | 개발자 | Claude Code |
| 5 | 태양 | 리뷰어 | Claude Code |

**공유 리소스**

| 파일시스템 | Git 저장소 | MCP 서버 |
|-----------|-----------|---------|
