...
`[스크린샷 위치: Claude 응답이 모바일에 스트리밍되는 화면]`
...
`[스크린샷 위치: 세션 목록에서 "도구 승인 필요" 상태 표시]`
...
`[스크린샷 위치: 승인 버튼 탭 후 Claude 작업 재개 화면]`
