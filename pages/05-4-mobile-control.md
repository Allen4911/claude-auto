...
![하단 입력창에 텍스트 입력 중인 화면](../assets/05-4-text-input.png)
...
![Claude 응답이 모바일에 스트리밍되는 화면](../assets/05-4-streaming.png)
...
![iOS 키보드 마이크 아이콘 탭 화면](../assets/05-4-ios-voice.png)
...
![Android 음성 입력 화면](../assets/05-4-android-voice.png)
...
![세션 목록에서 "도구 승인 필요" 상태 표시](../assets/05-4-tool-pending.png)

### 승인 화면 구성

해당 세션에 진입하면 승인 요청 카드가 표시됩니다.

![도구 승인 카드](../assets/05-4-approval.png)

![도구 승인 요청 카드 화면](../assets/05-4-tool-request.png)
...
![승인 버튼 탭 후 Claude 작업 재개 화면](../assets/05-4-approved.png)
...
![거부 후 Claude의 대안 제시 화면](../assets/05-4-denied.png)
...
!["이 세션에서 항상 허용" 체크박스](../assets/05-4-always-allow.png)
...
![도구 실행 결과 카드가 펼쳐진 화면](../assets/05-4-tool-result.png)
