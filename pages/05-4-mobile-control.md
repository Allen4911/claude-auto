...
![모바일 도구 승인 카드의 각 요소(도구 이름·실행 내용·설명·거부·승인 버튼)에 라벨을 단 도식](../assets/05-4-mobile-control-approval-card.png)
...
![승인 시 PC에서 즉시 실행, 거부 시 Claude가 대안 제시로 갈라지는 두 갈래 분기 흐름도](../assets/05-4-mobile-control-approve-reject.png)
