...
![쿠팡 상품 분석 AI 도구 팀 지휘 구조](../assets/08-6-cupangs.png)
...
![메일 자동화 시스템 Phase 1~5 구성도](../assets/08-6-mail-auto.png)
...
쭌은 270초마다 깨어나 각 pane 상태를 확인하고 사용자에게 보고한 뒤 다음 체크를 예약하길 반복합니다.
...
팀장이 사용자에게 현재 상황(rate limit 도달, 재개 예정 시각, 진행률)을 보고합니다.
...
리셋 시각에 맞춰 깨어나 팀원 pane 상태를 확인하고 재가동·보고까지 자동으로 이어집니다.
...
![민준 중심 지휘 체계 — 앨런→쭌→민준→팀원](../assets/08-6-central_command.png)
...
![칸반 기반 작업 진행 관리 보드](../assets/08-6-kanban-progress.png)
