...
비유하자면 superpowers 스킬은 **항공기 조종사의 체크리스트**와 같습니다. 베테랑 조종사도 이륙 전에 반드시 체크리스트를 읽습니다. 경험이 있어도 절차를 건너뛰지 않는 것이 안전의 핵심입니다. superpowers 스킬이 바로 그 역할을 합니다 — Claude가 유능해도 "이 스킬의 절차를 반드시 지킨다"는 보장이 생깁니다.
