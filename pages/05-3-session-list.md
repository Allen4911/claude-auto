...
![이름 붙인 팀 세션들이 모바일 목록에 나란히 표시돼 한눈에 구분되는 모습](../assets/05-3-session-list-named-sessions.png)
...
![초록·노랑·회색 상태 점의 의미와 취할 행동을 연결한 신호등형 상태 범례](../assets/05-3-session-list-status-legend.png)
