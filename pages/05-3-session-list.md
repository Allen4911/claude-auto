...
| 세션 | 상태 | 작업 | 시간 |
|------|------|------|------|
| 🖥 dev-machine-elegant-fox | ● ○ 응답 대기 중 | Backend API 리팩토링 | 방금 전 |
| 🖥 myproject-swift-otter | ● 실행 중 | 프론트엔드 빌드 | 3분 전 |
| 🖥 home-pc-gentle-river | 오프라인 | | |
...
`[스크린샷 위치: 세션 목록 상단 검색창에 "민준" 입력 후 필터된 결과]`
...
`[스크린샷 위치: iOS 세션 전환 - 뒤로가기 제스처]`

**Android:** 시스템 뒤로가기 버튼 또는 앱 내 뒤로가기 화살표를 탭합니다.

`[스크린샷 위치: Android 뒤로가기 버튼으로 세션 목록 복귀]`
