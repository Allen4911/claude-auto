...
![기존 1:1 방식의 세 가지 한계 — 단일 컨텍스트·순차 처리·디바이스 종속](../assets/01-2-what-is-remote-control-three-limits.png)
...
![새 기능 개발 6단계 시나리오 타임라인과 단계별 담당 에이전트](../assets/01-2-what-is-remote-control-scenario.png)
