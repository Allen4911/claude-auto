...
![GitHub Actions 비용 최적화 3가지 기법](../assets/08-2-github-actions-cost-optimize.png)

> 💡 GitHub Actions는 실행 시간만큼 무료 한도를 소모합니다. 위 세 가지는 "안 돌려도 되는 실행을 안 돌리는" 방법으로, 한도를 아끼는 가장 손쉬운 절약 수단입니다.
