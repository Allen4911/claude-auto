...
> 💡 **메시지 접두사란?** 메시지 맨 앞에 붙이는 짧은 표시(예: `[telegram:123]`)다. 팀장은 이 접두사를 보고 "어디서 온 지시인지, 어떻게 응답해야 하는지"를 판단한다. 접두사 규칙도 CLAUDE.md에 정의해 둔다.
...
![지시 수신·팀원 배분·결과 종합 보고가 한 바퀴 도는 Bot Mode 3단계 순환 흐름도](../assets/07-2-bot-mode-three-step-cycle.png)
